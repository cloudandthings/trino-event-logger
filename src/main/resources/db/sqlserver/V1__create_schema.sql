CREATE TABLE queries (
                         ...
                         failed_cumulative_memory FLOAT,
                         completed_splits BIGINT,
                         stage_gc_statistics NVARCHAR(MAX),
                         CONSTRAINT PK_queries PRIMARY KEY (id),
                         CONSTRAINT UQ_queries_query_id UNIQUE (query_id)
);

CREATE INDEX IX_created_finished ON queries (created, finished);